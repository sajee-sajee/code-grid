                    ...
                    {DISTRICTS.map((d) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{ fontSize: 40, marginBottom: 16, filter: unlocked ? `drop-shadow(0 0 10px ${d.color})` : "none" }}>{d.icon}</div>
                                ...
                                <div style={{ height: 4, background: "rgba(255,255,255,0.04)", borderRadius: 2, overflow: "hidden", marginBottom: 6 }}>
                                    <div style={{ width: `${(done / 3) * 100}%`, height: "100%", background: d.color, boxShadow: `0 0 6px ${d.color}`, transition: "width .6s cubic-bezier(0.16, 1, 0.3, 1)" }} />
                                </div>
                                
                                <div className="MONO" style={{ fontSize: 10, color: "var(--color-text-muted)", display: "flex", justifyContent: "space-between" }}>
                                    <span>PROGRESS:</span>
                                    <span style={{ color: unlocked ? "var(--color-text-secondary)" : "var(--color-text-muted)" }}>{done} / 3 SUB_MISSIONS</span>
                                </div>
                            </div>
                        );
                    })}
