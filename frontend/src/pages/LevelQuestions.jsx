        ...
        <div style={{ minHeight: "100vh", padding: 20, maxWidth: 1350, margin: "0 auto", position: "relative" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20, flexWrap: "wrap" }}>
                    ...
                    <div style={{ height: 28, fontSize: 24, display: "flex", alignItems: "center", filter: `drop-shadow(0 0 8px ${district.color})` }}>
                    ...
                    <div>
                        ...
                        <div className="MONO" style={{ fontSize: 9, color: "var(--color-text-muted)", letterSpacing: "0.1em" }}>
                            GRID PROTOCOL CONTEXT: MULTI_LANG_SANDBOXED
                        </div>
                    </div>
                        ...
                        <CyberCard style={{ padding: 0, overflow: "hidden" }} color="var(--color-green)">
                            ...
                            <div style={{ 
                                ...
                                <div className="MONO" style={{ fontSize: 11, color: "rgba(0, 255, 157, 0.6)", letterSpacing: "0.15em", fontWeight: 600 }}>
                                    MISSION_DECRYPT_{q.id.toUpperCase()}.{getFileExtension(language)}
                                </div>
                                <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 10 }}>
                                    <LanguagePicker value={language} onChange={handleLanguageChange} />
                                    {alreadySolved && (
                                        <span className="MONO gG" style={{ fontSize: 10, fontWeight: 700, background: "rgba(0,255,157,0.12)", padding: "2px 8px", borderRadius: 4 }}>
                                            ✓ COMPLETED
                                        </span>
                                    )}
                                    {xpPopup && <div className="MONO aXp gG" style={{ fontSize: 13, fontWeight: 700 }}>{xpPopup}</div>}
                                </div>
                            </div>
