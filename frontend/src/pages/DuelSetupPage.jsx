            ...
            <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 520, animation: "fadeIn 0.4s ease" }}>
                <CyberCard style={{ padding: 40 }} color="var(--color-red)">
                    ...
                    <div style={{ marginBottom: 36 }}>
                        ...
                        <div style={{ display: "flex", gap: 10 }}>
                            {[
                                ...
                                const isAvailable = availableDiffs.includes(d.name);
                                const active = selectedDiff === d.name;
                                return (
                                    <div 
                                        key={d.name} 
                                        onClick={() => { if (isAvailable) setDiff(d.name); }} 
                                        style={{ 
                                            flex: 1, 
                                            padding: "12px 0", 
                                            textAlign: "center", 
                                            ...
                                            color: active ? d.color : isAvailable ? "var(--color-text-secondary)" : "rgba(255,255,255,0.15)", 
                        ...
                        <div className="MONO" style={{ fontSize: 10, color: "rgba(255, 45, 85, 0.35)", marginTop: 10, letterSpacing: ".12em" }}>
                    ...
                    <div style={{ display: "flex", gap: 16 }}>
                        ...
                        <Btn variant="r" onClick={() => onStartDuel({ topic, diff: selectedDiff, levelId: selectedDistrict?.id || 1 })} style={{ flex: 2, justifyContent: "center" }}>
                            ⚔️ CONNECT UPLINK
                        </Btn>
                    </div>
                </CyberCard>
